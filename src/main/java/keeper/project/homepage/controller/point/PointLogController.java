...
import keeper.project.homepage.service.point.PointLogService;
...
public class PointLogController {
  ...
  public SingleResult<PointLogResult> savePointLog(
      @RequestBody PointLogRequest pointLogRequest
  ) {
    return responseService.getSuccessSingleResult(pointLogService.savePointLog(pointLogRequest));
  }
