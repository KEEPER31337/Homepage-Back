...
include::{snippets}/get-point-rankings/http-request.adoc[]

==== Request Parameters

include::{snippets}/get-point-rankings/request-parameters.adoc[]

=== 응답

==== Response Body

include::{snippets}/get-point-rankings/response-body.adoc[]

==== Response Fields

include::{snippets}/get-point-rankings/response-fields.adoc[]