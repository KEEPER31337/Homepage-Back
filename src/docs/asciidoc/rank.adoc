...
include::{snippets}/rank-list/http-request.adoc[]

==== Request Parameters

include::{snippets}/rank-list/request-parameters.adoc[]

NOTE: size가 null일 경우 모든 정보를 불러옵니다.

=== 응답

==== Response Body

include::{snippets}/rank-list/response-body.adoc[]

==== Response Fields

include::{snippets}/rank-list/response-fields.adoc[]