...
include::{snippets}/survey-visible-latest/response-body.adoc[]
...
include::{snippets}/survey-closed-latest/path-parameters.adoc[]
...
include::{snippets}/survey-closed-latest/response-body.adoc[]
