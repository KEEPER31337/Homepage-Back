...
include::{snippets}/delete-merit-log-list/http-request.adoc[]

==== Request Parameters

include::{snippets}/delete-merit-log-list/request-parameters.adoc[]

=== 응답

==== Response

include::{snippets}/delete-merit-log-list/http-response.adoc[]

==== Response Field

include::{snippets}/delete-merit-log-list/response-fields.adoc[]
...
include::{snippets}/update-merit-log-list/http-request.adoc[]

==== Request Fields

include::{snippets}/update-merit-log-list/request-fields.adoc[]
