...
include::{snippets}/attend-get-my-date-list/request-fields.adoc[]
...
include::{snippets}/attend-get-info/request-fields.adoc[]
...
include::{snippets}/attend-get-all/request-fields.adoc[]
